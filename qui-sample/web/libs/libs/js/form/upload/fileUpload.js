...
//				uploadUrl = contextPath + prefs.uploadUrl;
				...
				if(catalogId&&kind&&moduleId){
					uploadUrl=checkUrl(uploadUrl) + "catalogId=" + catalogId + "&moduleId=" + moduleId + "&kind="+kind;
				}
				else if(catalogId){
					uploadUrl=checkUrl(uploadUrl) + "catalogId=" + catalogId;
				}
				else if(moduleId){
					uploadUrl=checkUrl(uploadUrl) + "moduleId=" + moduleId;
				}
				else if(kind){
					uploadUrl=checkUrl(uploadUrl) + "kind=" + kind;
				}
				else if(catalogId&&kind){
					uploadUrl=checkUrl(uploadUrl) + "catalogId=" + catalogId + "&kind="+kind;
				}
				else if(catalogId&&moduleId){
					uploadUrl=checkUrl(uploadUrl) + "catalogId=" + catalogId + "&moduleId="+moduleId;
				}
				else if(kind&&moduleId){
					uploadUrl=checkUrl(uploadUrl) + "kind=" + kind + "&moduleId="+moduleId;
				}
		    }else{
...
//		    	deleteUrl = contextPath + prefs.deleteUrl;
		    ...
		    if(prefs.deleteAllUrl){
				...
				if(catalogId&&kind){
					deleteAllUrl=checkUrl(deleteAllUrl) + "catalogId=" + catalogId + "&kind=" + kind;
				}
				else if(catalogId){
					deleteAllUrl=checkUrl(deleteAllUrl)+"catalogId=" + catalogId;
				}
				else if(kind){
					deleteAllUrl=checkUrl(deleteAllUrl)+"kind=" + kind;
				}
		    }else{
...
//		    	listUrl = contextPath + prefs.listUrl;
				...
				if(catalogId&&kind){
					listUrl=checkUrl(listUrl) + "catalogId=" + catalogId + "&kind=" + kind;
				}
				else if(catalogId){
					listUrl=checkUrl(listUrl)+"catalogId=" + catalogId;
				}
				else if(kind){
					listUrl=checkUrl(listUrl)+"kind=" + kind;
				}
		    }else{
		 ...
		 var uploader = new SWFUpload({
		 	catalogId : catalogId,
		 	allowRepeat : prefs.allowRepeat === true ? true : false,
			//路径
